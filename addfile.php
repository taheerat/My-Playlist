		...
		<div id="site-content">
			...
			<main class="main-content">
                 <div class="fullwidth-block inner-content">
					<div class="container">
						<h2 class="page-title" style="text-align: center;">Add Your Favourite Song</h2>
						<div class="row">
							...
							?>
								<form action="addfile.php" method="post" class="contact-form">
									...
									<input type="radio" placeholder="File title" name="type" value="Romantic songs">Romantic songs
									<input type="radio" placeholder="File title" name="type" value="Sad songs">Sad songs
			...
			<footer class="site-footer">
				<div class="container">
					...
					<address>
						<p>Taheera Tanveer<br><a href="tel:354543543"></a> <br> <a href="mailto:info@bandname.com">myplaylist@gmail.com</a></p>
					</address>
