		...
		<div id="site-content">
				...
				<div class="slider">
					<ul class="slides">
						<li class="lazy-bg" data-background="dummy/slide-1.jpg">
							<div class="container">
								<h2 class="slide-title">My Playlist</h2>
								<h3 class="slide-subtitle">All Favourite Song In a Place</h3>
					...
					<div class="container">
						<div class="quote-slider">
							<ul class="slides">
								<li>
									<blockquote>
										<p>"It's essential to include music metadata in your music collection, to keep it navigable and well organized"
										</p>
										<cite>Taheera </cite>
								...
								<li>
									<blockquote>
										<p>"Music Online is a suite of databases offering full length streaming recordings of music in a variety of genres."
										</p>
										<cite>Nilofer</cite>
										<span>My Playlist</span>
									</blockquote>
								...
								<li>
								    <blockquote>
									   <p> "One of my favorite features of their search functionality is the ability to use a slide bar to specify the exact length of a track I’m looking for – quite useful for specific timing in videos!"
									   </p>
									   <cite> Tanveer </cite>
									   <span> My Playlist</span>
									</blockquote>  
			...
			<footer class="site-footer">
				<div class="container">
					...
					<address>
						<p>Taheera Tanveer<br><a href="tel:354543543"></a> <br> <a href="mailto:info@bandname.com">playlistt@gmail.com</a></p>
					</address>
					...
					<p class="copy">Copyright 2019 Myplaylist. All right reserved</p>
				</div>
			</footer> <!-- .site-footer -->
