...
<div id="mySidenav" class="sidenav">
	...
	<a href="loverelationshipsong.php">Romantic songs</a>
	<a href="sadlove.php">Sad songs</a>
		        ...
		        <div class="modal-footer">
		          <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
						...
						<?php
								...
								$sql1 ="SELECT * FROM filelist WHERE user_id = '$id' AND catagory='Sad songs'";
								$title = 'catagory';
								$link = 'file';
							    ...
							    while($row=mysqli_fetch_assoc($result1))
								{
									...
									$title = $row['title'];
									$link = $row['file'];
									$output = "<form method=\"get\" action=\"sad.php\">
		  ...
		  ?>
			...
			<footer class="site-footer">
				<div class="container">
					...
					<address>
						<p>Taheera Tanveer<br><a href="tel:354543543"></a> <br> <a href="mailto:info@bandname.com">playlist@gmail.com</a></p>
					</address>
